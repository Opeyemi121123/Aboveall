...
exports.groupsg = async (
  ...
  try {
    ...
    let _0x33935f = Aboveall_grop.decodeJid(Aboveall_grop.user.id);
    let _0xbacc49 = _0x33935f.split("@")[0];
    let Aboveall_bot = {
      ...group_sss,
    };
    Aboveall_bot.chat = Aboveall_bot.jid = Aboveall_bot.from = group_sss.id;
    Aboveall_bot.user = Aboveall_bot.sender = Array.isArray(group_sss.participants)
      ? group_sss.participants[0]
      : "xxx";
    Aboveall_bot.name = await Aboveall_grop.getName(Aboveall_bot.user);
    Aboveall_bot.userNum = Aboveall_bot.senderNum = Aboveall_bot.user.split("@")[0];
    Aboveall_bot.time = getTime("h:mm:ss a");
    Aboveall_bot.date = getTime("dddd, MMMM Do YYYY");
    Aboveall_bot.action = Aboveall_bot.status = group_sss.action;
    Aboveall_bot.isCreator = [
      _0xbacc49,
      ...Astro,
      ...global.sudo?.split(","),
      ...global.devs?.split(","),
      ...
      .includes(Aboveall_bot.user);
    Aboveall_bot.isAstro = [...Astro]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(Aboveall_bot.user);
    Aboveall_bot.fromMe = Aboveall_bot.isAstro
      ? true
      : areJidsSameUser(Aboveall_bot.user, _0x33935f);
    if (Aboveall_bot.action === "remove" && Aboveall_bot.fromMe) {
      return;
    }
    Aboveall_bot.AboveallBot = [...Astro]
      .map((_0x43191b) => _0x43191b.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(_0x33935f);
    Aboveall_bot.blockJid = [
      "120363023983262391@g.us",
      "120363025246125888@g.us",
      ...global.blockJids?.split(","),
    ].includes(Aboveall_bot.chat);
    Aboveall_bot.isGroup = Aboveall_bot.chat.endsWith("@g.us");
    if (Aboveall_bot.isGroup) {
      Aboveall_bot.metadata = await Aboveall_grop.groupMetadata(Aboveall_bot.chat);
      gcs[Aboveall_bot.chat] = Aboveall_bot.metadata;
      Aboveall_bot.admins = Aboveall_bot.metadata.participants.reduce(
        (_0x3d4871, _0xe2eb9e) =>
          (_0xe2eb9e.admin
            ? _0x3d4871.push({
                id: _0xe2eb9e.id,
      ...
      Aboveall_bot.isAdmin = !!Aboveall_bot.admins.find(
        (_0x859f83) => _0x859f83.id === Aboveall_bot.user
      );
      Aboveall_bot.isBotAdmin = !!Aboveall_bot.admins.find(
        (_0x40eef6) => _0x40eef6.id === _0x33935f
      );
    }
    Aboveall_bot.kick = Aboveall_bot.remove = (_0x48f5af = Aboveall_bot.user) =>
      Aboveall_grop.groupParticipantsUpdate(Aboveall_bot.chat, [_0x48f5af], "remove");
    Aboveall_bot.add = (_0x422af3 = Aboveall_bot.user) =>
      Aboveall_grop.groupParticipantsUpdate(Aboveall_bot.chat, [_0x422af3], "add");
    Aboveall_bot.promote = (_0x3d0644 = Aboveall_bot.user) =>
      Aboveall_grop.groupParticipantsUpdate(Aboveall_bot.chat, [_0x3d0644], "promote");
    Aboveall_bot.demote = (_0x37d435 = Aboveall_bot.user) =>
      Aboveall_grop.groupParticipantsUpdate(Aboveall_bot.chat, [_0x37d435], "demote");
    Aboveall_bot.getpp = async (_0x577c8f = Aboveall_bot.user) => {
      try {
        return await Aboveall_grop.profilePictureUrl(_0x577c8f, "image");
      } catch {
        return "https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg";
      }
    };
    Aboveall_bot.sendMessage = async (
      _0x5a0f4b = Aboveall_bot.chat,
      _0x2c78a3 = {},
      _0x11fd9c = {
        quoted: "",
      }
    ) => {
      return await Aboveall_grop.sendMessage(_0x5a0f4b, _0x2c78a3, _0x11fd9c);
    };
    Aboveall_bot.sendUi = async (
      _0x107cb3 = Aboveall_bot.chat,
      _0x15a4e0 = {},
      _0x1e19fa = "",
      _0x3b7229 = false,
      _0x289e17 = false,
      ...
      return await Aboveall_grop.sendUi(
        _0x107cb3,
        _0x15a4e0,
        _0x1e19fa,
        _0x3b7229,
    ...
    Aboveall_bot.error = async (
      ...
      let _0x51c1e7 = _0x471ef2
        ...
        ? Aboveall_bot.chat
        : Aboveall_bot.botNumber;
      let _0x1ac461 =
        "*CMD ERROR*\n```\nUSER: @" +
        Aboveall_bot.user.split("@")[0] +
      ...
      if (
        _0x129b35 &&
        Config.errorChat !== "chat" &&
        Aboveall_bot.chat !== Aboveall_bot.botNumber
      ) {
        await Aboveall_grop.sendMessage(Aboveall_bot.jid, {
          text: _0x129b35,
        });
      }
      console.log(_0xfedfc2 ? _0xfedfc2 : _0x386924);
      try {
        return await Aboveall_grop.sendMessage(
          _0x51c1e7,
          {
            text: _0x1ac461,
            ..._0x32def3,
            mentions: [Aboveall_bot.user],
          },
          {
    ...
    Aboveall_bot.send = async (
      ...
      _0xb61629 = "Aboveall",
      _0x919f26 = "",
      _0x3ccfb1 = Aboveall_bot.chat
    ) => {
      _0x3ccfb1 = _0x3ccfb1 ? _0x3ccfb1 : Aboveall_bot.chat;
      switch (_0xb61629.toLowerCase()) {
        ...
        case "react":
          {
            return await Aboveall_grop.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
        ...
        case "img":
          {
            if (Buffer.isBuffer(_0x1def38)) {
              ...
              return Aboveall_grop.sendMessage(
                _0x3ccfb1,
                {
                  image: {
                    url: _0x1def38,
        ...
        case "pool":
          {
            return await Aboveall_grop.sendMessage(
              ...
              {
                quoted: _0x919f26,
                messageId: Aboveall_grop.messageId(),
              }
            );
          }
          break;
        ...
        case "sticker":
          {
            let { data: _0x2a29f3, mime: _0x48e80f } = await Aboveall_grop.getFile(
              _0x1def38
            );
            if (_0x48e80f == "image/webp") {
              let _0x500c5a = await writeExifWebp(_0x2a29f3, _0x1bb9da);
              await Aboveall_grop.sendMessage(_0x3ccfb1, {
                sticker: {
                  url: _0x500c5a,
                },
                ..._0x1bb9da,
              ...
              await Aboveall_grop.sendImageAsSticker(
                _0x3ccfb1,
                _0x1def38,
                _0x1bb9da
              );
    ...
    Aboveall_bot.sendPoll = async (
      _0x188344,
      _0x4bb725 = ["option 1", "option 2"],
      _0x34efb6 = 1,
      _0xf53aa9 = "",
      _0x2efafc = Aboveall_bot.jid
    ) => {
      return await Aboveall_bot.send(
        _0x188344,
        {
          values: _0x4bb725,
    ...
    Aboveall_bot.checkBot = (_0x31c33b = Aboveall_bot.sender) =>
      [...Astro, _0xbacc49]
        .map((_0x1e666c) => _0x1e666c.replace(/[^0-9]/g) + "@s.whatsapp.net")
        .includes(_0x31c33b);
    Aboveall_bot.botNumber = _0x33935f;
    Aboveall_bot.bot = _0x56741f ? Aboveall_grop : {};
    if (global.AstroOfficial && global.AstroOfficial === "yes") {
      return Aboveall_bot;
    } else {
      return {};
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("AboveallMD");

...
async function syncdb() {
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x1f88ec = 
`🖤🔮 **ALL HAIL *${Config.botname}*! THE ONE WHO EMBRACES THE SHADOWS HAS AWAKENED!** 🔮🖤\n' +
'「 *Dark Realms* Now Active 」\n\n' +
'⚔️ **Command Prefix**: ${Config.HANDLERS}\n' +
'📜 **Issued Decrees**: ${events.commands.length}\n' +
'🏴‍☠️ **Operating Mode**: ${Config.WORKTYPE} Governance\n' +
'🏰 **Database**: ${(isMongodb ? "💎 MongoDb" : sqldb ? "📚 PostgreSql" : "🌸 ᴀʙᴏᴠᴇ ᴀʟʟ")}\n' +
'🌙 _Welcome to the Realm_ 🌙\n' +
'👑 **Leader**: ${Config.ownername}\n' +
'🛡️ **Trusted Guardian**: ${global.sudo}\n' +
'🌹 **Greeting Message**: ${global.wlcm}\n' +
'🍂 **Farewell Message**: ${global.gdbye}\n\n' +
'🖤 *${Config.botname}* stands ready to guide the shadows and illuminate the path! 🖤`;
      try {

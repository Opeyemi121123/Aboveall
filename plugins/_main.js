...
const scan = "https://aboveall-pair.onrender.com/";
...
smd({
  ...
  try {
    ...
    let { data: _0x44f98c } = await axios.get("https://api.github.com/repos/JUPITERBOLD05/Aboveall");
    
    let _0x1c73f9 = (`
ABOVEALL ᴀ sɪᴍᴘʟᴇ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ, ᴍᴀᴅᴇ ʙʏ JUPITERBOLD05 ᴀɴᴅ ᴅᴇᴘʟᴏʏᴇᴅ ʙʏ *JUPITERBOLD05*.
...
smd(
  ...
  async (message, match) => {
    ...
    const queryUrl = `https://aboveall-pair.onrender.com/code?number=${number}`;
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*ABOVEALL • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("Aboveall • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("Aboveall • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
